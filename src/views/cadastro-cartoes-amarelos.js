...
function CadastroAmarelos() {
    ...
    if (idParam == null) {
      await axios
        ...
        .then(function (response) {
          mensagemSucesso(`Amarelo cadastrado com sucesso!`);
          navigate(`/listagem-amarelos`);
        })
      ...
      await axios
        ...
        .then(function (response) {
          mensagemSucesso(`Amarelo alterado com sucesso!`);
          navigate(`/listagem-amarelos`);
        })
        .catch(function (error) {
          mensagemErro(error.response.data);
  ...
  return (
    <div className='container'>
      <Card title='Cadastro de Amarelo'>
        <div className='row'>
...
export default CadastroAmarelos;
