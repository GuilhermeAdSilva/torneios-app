...
function CadastroVermelhos() {
    ...
    if (idParam == null) {
      await axios
        ...
        .then(function (response) {
          mensagemSucesso(`Vermelho cadastrado com sucesso!`);
          navigate(`/listagem-vermelhos`);
        })
      ...
      await axios
        ...
        .then(function (response) {
          mensagemSucesso(`Vermelho alterado com sucesso!`);
          navigate(`/listagem-vermelhos`);
        })
        .catch(function (error) {
          mensagemErro(error.response.data);
  ...
  return (
    <div className='container'>
      <Card title='Cadastro de Vermelho'>
        <div className='row'>
...
export default CadastroVermelhos;
