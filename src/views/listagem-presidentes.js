...
function ListagemPresidentes() {
  ...
  async function excluir(id) {
    ...
    await axios
      ...
      .then(function (response) {
        mensagemSucesso(`Presidente excluído com sucesso!`);
        setDados(
          dados.filter((dado) => {
            return dado.id !== id;
          })
      ...
      .catch(function (error) {
        mensagemErro(`Erro ao excluir o presidente`);
      });
  }
  ...
  return (
    <div className='container'>
      <Card title='Listagem de Presidentes'>
        <div className='row'>
            ...
            <div className='bs-component'>
              ...
              <table className='table table-hover'>
                ...
                <tbody>
                  {dados.map((dado) => (
                    <tr key={dado.id}>
                      <td><a href= {`/visualizar-presidentes/${dado.id}`}>{dado.nome}</a></td>
                      <td>
